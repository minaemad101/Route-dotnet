...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20251007215049_initialcreate")]
                    ...
                    b.ToTable("Members", t =>
                        {
                            ...
                            t.HasCheckConstraint("GymUserValidPhobeCheck", "Phone Like '01%' and Phone Not Like'%[^0-9]%'");
                        });
                });
                    ...
                    b.ToTable("Trainers", t =>
                        {
                            ...
                            t.HasCheckConstraint("GymUserValidPhobeCheck", "Phone Like '01%' and Phone Not Like'%[^0-9]%'")
                                .HasName("GymUserValidPhobeCheck1");
                        });
                });
